<?php
/*
 * upgrade1.php - corrected Client/server model
 *
 * Scenario 1 capacity additions:
 *  1. Upgrade the SNA Gateway CPU to 16 MIPS.
 *  2. Add 1 more disk to the File server.
 *
 * Revised by njgunther@perfdynamics.com Thu Nov 15 11:33:23  2001
 * Updated by njgunther@perfdynamics.com Sun Nov 18 19:29:39  2001
 *
...
define("FS_DISKS",1);  /* Baseline was 1 disk */
define("MF_DISKS",4);
...
function main()
{
    ...
    */
	...
	for ($dev = 0; $dev < $noNodes; $dev++) {
		...
		if (strcmp($node[$dev]->devname, "TR") == 0) $ulan += $util[$dev];
	};
