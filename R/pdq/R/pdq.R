...
{
  if(is.list(s_visits))
  assert(all(sapply(s_visits, class) == "_p_double"))     
...
{
  if(is.list(s_service))
  assert(all(sapply(s_service, class) == "_p_double"))     
...
{
  if(is.list(s_demand))
  assert(all(sapply(s_demand, class) == "_p_double"))     
...
{
  if(is.list(s_resit))
  assert(all(sapply(s_resit, class) == "_p_double"))     
...
{
  if(is.list(s_utiliz))
  assert(all(sapply(s_utiliz, class) == "_p_double"))     
...
{
  if(is.list(s_qsize))
  assert(all(sapply(s_qsize, class) == "_p_double"))     
...
{
  if(is.list(s_avqsize))
  assert(all(sapply(s_avqsize, class) == "_p_double"))     
