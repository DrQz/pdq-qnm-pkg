...
`SYSTAT_TYPE` = function()
{
  ...
  ans <- new("_p_SYSTAT_TYPE", ref=ans) ;
  
  reg.finalizer(ans@ref, delete_SYSTAT_TYPE)
  ans
...
`TERMINAL_TYPE` = function()
{
  ...
  ans <- new("_p_TERMINAL_TYPE", ref=ans) ;
  
  reg.finalizer(ans@ref, delete_TERMINAL_TYPE)
  ans
...
`BATCH_TYPE` = function()
{
  ...
  ans <- new("_p_BATCH_TYPE", ref=ans) ;
  
  reg.finalizer(ans@ref, delete_BATCH_TYPE)
  ans
...
`TRANSACTION_TYPE` = function()
{
  ...
  ans <- new("_p_TRANSACTION_TYPE", ref=ans) ;
  
  reg.finalizer(ans@ref, delete_TRANSACTION_TYPE)
  ans
...
`JOB_TYPE_should_be_class_set` = function(self, s_should_be_class)
{
  ...
  if(length(s_should_be_class) > 1) {
    warning("using only the first element of s_should_be_class");
  };
...
attr(`JOB_TYPE_should_be_class_set`, "inputTypes") = c('_p_JOB_TYPE', 'integer')
...
attr(`JOB_TYPE_should_be_class_get`, 'returnType') = 'integer'
...
`JOB_TYPE_network_set` = function(self, s_network)
{
  ...
  if(length(s_network) > 1) {
    warning("using only the first element of s_network");
  };
...
attr(`JOB_TYPE_network_set`, "inputTypes") = c('_p_JOB_TYPE', 'integer')
...
attr(`JOB_TYPE_network_get`, 'returnType') = 'integer'
...
`JOB_TYPE` = function()
{
  ...
  ans <- new("_p_JOB_TYPE", ref=ans) ;
  
  reg.finalizer(ans@ref, delete_JOB_TYPE)
  ans
...
`NODE_TYPE_devtype_set` = function(self, s_devtype)
{
  ...
  if(length(s_devtype) > 1) {
    warning("using only the first element of s_devtype");
  };
...
attr(`NODE_TYPE_devtype_set`, "inputTypes") = c('_p_NODE_TYPE', 'integer')
...
attr(`NODE_TYPE_devtype_get`, 'returnType') = 'integer'
...
`NODE_TYPE_sched_set` = function(self, s_sched)
{
  ...
  if(length(s_sched) > 1) {
    warning("using only the first element of s_sched");
  };
...
attr(`NODE_TYPE_sched_set`, "inputTypes") = c('_p_NODE_TYPE', 'integer')
...
attr(`NODE_TYPE_sched_get`, 'returnType') = 'integer'
...
attr(`NODE_TYPE_visits_set`, "inputTypes") = c('_p_NODE_TYPE', 'numeric')
...
{
  self = slot(self,"ref") 
  ;.Call('R_swig_NODE_TYPE_visits_get', self, as.logical(.copy), PACKAGE='pdq');
  
}

attr(`NODE_TYPE_visits_get`, 'returnType') = 'numeric'
...
attr(`NODE_TYPE_service_set`, "inputTypes") = c('_p_NODE_TYPE', 'numeric')
...
{
  self = slot(self,"ref") 
  ;.Call('R_swig_NODE_TYPE_service_get', self, as.logical(.copy), PACKAGE='pdq');
  
}

attr(`NODE_TYPE_service_get`, 'returnType') = 'numeric'
...
attr(`NODE_TYPE_demand_set`, "inputTypes") = c('_p_NODE_TYPE', 'numeric')
...
{
  self = slot(self,"ref") 
  ;.Call('R_swig_NODE_TYPE_demand_get', self, as.logical(.copy), PACKAGE='pdq');
  
}

attr(`NODE_TYPE_demand_get`, 'returnType') = 'numeric'
...
attr(`NODE_TYPE_resit_set`, "inputTypes") = c('_p_NODE_TYPE', 'numeric')
...
{
  self = slot(self,"ref") 
  ;.Call('R_swig_NODE_TYPE_resit_get', self, as.logical(.copy), PACKAGE='pdq');
  
}

attr(`NODE_TYPE_resit_get`, 'returnType') = 'numeric'
...
attr(`NODE_TYPE_utiliz_set`, "inputTypes") = c('_p_NODE_TYPE', 'numeric')
...
{
  self = slot(self,"ref") 
  ;.Call('R_swig_NODE_TYPE_utiliz_get', self, as.logical(.copy), PACKAGE='pdq');
  
}

attr(`NODE_TYPE_utiliz_get`, 'returnType') = 'numeric'
...
attr(`NODE_TYPE_qsize_set`, "inputTypes") = c('_p_NODE_TYPE', 'numeric')
...
{
  self = slot(self,"ref") 
  ;.Call('R_swig_NODE_TYPE_qsize_get', self, as.logical(.copy), PACKAGE='pdq');
  
}

attr(`NODE_TYPE_qsize_get`, 'returnType') = 'numeric'
...
attr(`NODE_TYPE_avqsize_set`, "inputTypes") = c('_p_NODE_TYPE', 'numeric')
...
{
  self = slot(self,"ref") 
  ;.Call('R_swig_NODE_TYPE_avqsize_get', self, as.logical(.copy), PACKAGE='pdq');
  
}

attr(`NODE_TYPE_avqsize_get`, 'returnType') = 'numeric'
...
`NODE_TYPE` = function()
{
  ...
  ans <- new("_p_NODE_TYPE", ref=ans) ;
  
  reg.finalizer(ans@ref, delete_NODE_TYPE)
  ans
...
attr(`CreateClosed`, 'returnType') = 'integer'
attr(`CreateClosed`, "inputTypes") = c('character', 'integer', 'numeric', 'numeric')
...
attr(`CreateClosed_p`, 'returnType') = 'integer'
attr(`CreateClosed_p`, "inputTypes") = c('character', 'integer', 'numeric', 'numeric')
...
attr(`CreateOpen`, 'returnType') = 'integer'
...
attr(`CreateOpen_p`, 'returnType') = 'integer'
...
`CreateNode` = function(name, device, sched, .copy = FALSE)
{
  ...
  if(length(device) > 1) {
    warning("using only the first element of device");
  };
  
  sched = as.integer(sched);
  
  if(length(sched) > 1) {
    warning("using only the first element of sched");
  };
...
attr(`CreateNode`, 'returnType') = 'integer'
attr(`CreateNode`, "inputTypes") = c('character', 'integer', 'integer')
...
`CreateMultiNode` = function(servers, name, device, sched, .copy = FALSE)
{
  ...
  if(length(servers) > 1) {
    warning("using only the first element of servers");
  };
...
attr(`CreateMultiNode`, 'returnType') = 'integer'
attr(`CreateMultiNode`, "inputTypes") = c('integer', 'character', 'integer', 'integer')
...
attr(`GetStreamsCount`, 'returnType') = 'integer'
...
attr(`GetNodesCount`, 'returnType') = 'integer'
...
attr(`GetUtilization`, "inputTypes") = c('character', 'character', 'integer')
...
attr(`GetQueueLength`, "inputTypes") = c('character', 'character', 'integer')
...
attr(`PDQ_GetThruMax`, "inputTypes") = c('integer', 'character')
...
attr(`SetDebug`, "inputTypes") = c('integer')
...
attr(`Solve`, "inputTypes") = c('integer')
...
attr(`GetNode`, "inputTypes") = c('integer')
...
attr(`getjob`, "inputTypes") = c('integer')
...
{
  s = as(s, "character"); 
  ;.Call('R_swig_resets', s, PACKAGE='pdq');
  
}

attr(`resets`, 'returnType') = 'void'
attr(`resets`, "inputTypes") = c('character')
class(`resets`) = c("SWIGFunction", class('resets'))

# Start of debug

`debug` = function(proc, info)
{
  proc = as(proc, "character"); 
  info = as(info, "character"); 
  ;.Call('R_swig_debug', proc, info, PACKAGE='pdq');
  
}

attr(`debug`, 'returnType') = 'void'
attr(`debug`, "inputTypes") = c('character', 'character')
class(`debug`) = c("SWIGFunction", class('debug'))

# Start of errmsg

`errmsg` = function(pname, msg)
{
  pname = as(pname, "character"); 
  msg = as(msg, "character"); 
  ;.Call('R_swig_errmsg', pname, msg, PACKAGE='pdq');
  
}

attr(`errmsg`, 'returnType') = 'void'
attr(`errmsg`, "inputTypes") = c('character', 'character')
class(`errmsg`) = c("SWIGFunction", class('errmsg'))

# Start of approx

`approx` = function()
{
  ;.Call('R_swig_approx', PACKAGE='pdq');
  
}

attr(`approx`, 'returnType') = 'void'
class(`approx`) = c("SWIGFunction", class('approx'))

# Start of canonical

`canonical` = function()
{
  ;.Call('R_swig_canonical', PACKAGE='pdq');
  
}

attr(`canonical`, 'returnType') = 'void'
class(`canonical`) = c("SWIGFunction", class('canonical'))

# Start of exact

`exact` = function()
{
  ;.Call('R_swig_exact', PACKAGE='pdq');
  
}

attr(`exact`, 'returnType') = 'void'
class(`exact`) = c("SWIGFunction", class('exact'))

# Start of getjob_index

`getjob_index` = function(wname, .copy = FALSE)
{
  wname = as(wname, "character"); 
  ;.Call('R_swig_getjob_index', wname, as.logical(.copy), PACKAGE='pdq');
  
}

attr(`getjob_index`, 'returnType') = 'integer'
attr(`getjob_index`, "inputTypes") = c('character')
class(`getjob_index`) = c("SWIGFunction", class('getjob_index'))

# Start of getjob_name

`getjob_name` = function(str, c)
{
  ...
  ;.Call('R_swig_getjob_name', str, c, PACKAGE='pdq');
  
}

attr(`getjob_name`, 'returnType') = 'void'
attr(`getjob_name`, "inputTypes") = c('character', 'integer')
class(`getjob_name`) = c("SWIGFunction", class('getjob_name'))

# Start of getnode_index

`getnode_index` = function(name, .copy = FALSE)
{
  name = as(name, "character"); 
  ;.Call('R_swig_getnode_index', name, as.logical(.copy), PACKAGE='pdq');
  
}

attr(`getnode_index`, 'returnType') = 'integer'
attr(`getnode_index`, "inputTypes") = c('character')
class(`getnode_index`) = c("SWIGFunction", class('getnode_index'))

# Start of typetostr

`typetostr` = function(str, type)
{
  str = as(str, "character"); 
  ...
  ;.Call('R_swig_typetostr', str, type, PACKAGE='pdq');
  
}

attr(`typetostr`, 'returnType') = 'void'
attr(`typetostr`, "inputTypes") = c('character', 'integer')
class(`typetostr`) = c("SWIGFunction", class('typetostr'))
...
`nodes_set` = function(s_nodes)
{
  ...
  if(length(s_nodes) > 1) {
    warning("using only the first element of s_nodes");
  };
...
attr(`nodes_set`, "inputTypes") = c('integer')
...
attr(`nodes_get`, 'returnType') = 'integer'
...
`streams_set` = function(s_streams)
{
  ...
  if(length(s_streams) > 1) {
    warning("using only the first element of s_streams");
  };
...
attr(`streams_set`, "inputTypes") = c('integer')
...
attr(`streams_get`, 'returnType') = 'integer'
