...
pdq::CreateClosed("Production", $pdq::TERM, 20.0, 20.0);
pdq::CreateClosed("Developmnt", $pdq::TERM, 15.0, 15.0);

pdq::CreateNode("CPU", $pdq::CEN, $pdq::FCFS);

if ($PRIORITY) { 
	# Create shadow CPU queue
    pdq::CreateNode("shadCPU", $pdq::CEN, $pdq::FCFS);
}

pdq::CreateNode("DK1", $pdq::CEN, $pdq::FCFS);
pdq::CreateNode("DK2", $pdq::CEN, $pdq::FCFS);
