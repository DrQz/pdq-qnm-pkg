...
pdq::CreateNode($NodeName1, $pdq::CEN, $pdq::FCFS);
pdq::CreateNode($NodeName2, $pdq::CEN, $pdq::FCFS);
pdq::CreateNode($NodeName3, $pdq::CEN, $pdq::FCFS);
pdq::CreateNode($NodeName4, $pdq::CEN, $pdq::FCFS);
