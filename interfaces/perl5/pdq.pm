...
*errmsg = *pdqc::errmsg;
*approx = *pdqc::approx;
*canonical = *pdqc::canonical;
*exact = *pdqc::exact;
*getjob_index = *pdqc::getjob_index;
*getjob_name = *pdqc::getjob_name;
*getnode_index = *pdqc::getnode_index;
*typetostr = *pdqc::typetostr;
